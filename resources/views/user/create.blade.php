                  ...
                  <form  method="post" action="{{ route('userCreate')}}">
                    ...
                    <div class="d-grid gap-2">
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="role_id"  value="1" id="SuperAdmin"  required>
                        <label class="form-check-label" for="SuperAdmin">
                          Super Admin
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="role_id"  value="2" id="Moderator" required>
                        <label class="form-check-label" for="Moderator">
                          Moderator
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="radio" name="role_id"  value="3" id="User" required>
